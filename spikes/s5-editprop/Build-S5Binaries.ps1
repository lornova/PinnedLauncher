#Requires -Version 7
# PinnedLauncher spike S-5 (throwaway): compiles the scratch console tool into
# bin\ using the newest installed Visual Studio C++ toolchain (x64).
